...
const customerSchema = new mongoose.Schema({
  user: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null }, source: { type: String, enum: ['local', 'shopify'], default: 'local', index: true }, shopifyCustomerId: { type: String, trim: true, unique: true, sparse: true },
